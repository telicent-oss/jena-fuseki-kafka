...
abstract class AbstractDockerProjectionTests extends AbstractDockerTests {
    ...
    protected void verifyProjection(int batchSize, DatasetGraph dsg, String consumerGroupBaseId) {
        // Given
        Properties props = AbstractDockerProjectionTests.prepareProperties();
        KConnectorDesc conn = AbstractDockerProjectionTests.prepareConnector(props);
        KafkaRdfPayloadSource<Bytes> source = AbstractDockerProjectionTests.prepareSource(batchSize, conn, consumerGroupBaseId);
