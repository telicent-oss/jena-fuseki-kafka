...
public class DockerTestSecureKafka {
    // Logging
    ...
    private static final KafkaTestCluster<?> mock = new SecureKafkaTestCluster();
    ...
    Properties consumerProps() {
        ...
        consumerProps.put("bootstrap.servers", mock.getBootstrapServers());
        consumerProps.putAll(mock.getClientProperties());
    ...
    @Test public void fk01_topic() throws ExecutionException, InterruptedException {
        mock.resetTopic(TOPIC);
        Collection<String> topics = mock.getAdminClient().listTopics().names().get();
